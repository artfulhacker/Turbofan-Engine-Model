...
using System.Linq;
using System.Text;
using Standard_Atmosphere;

namespace Engine_Real_TurboFan
{
    public class Real_TurboFan : IDisposable
    {
        //// Input Values
        ...
        public Real_TurboFan(double h, double M_0, double hpr, double T0_4, double pi_c, double pi_f, double pi_dmax, double alpha, double ec, double ef, double et, double eta_b, double eta_m, double pi_n, double P0P7, double P0P9, bool bae, double th, double d, double mr, double fw)
        {
        ...
        {
            using (atmospheric_cal a = new atmospheric_cal(h))
            {
