...
using System.Linq;
using System.Text;
using Engine_Real_TurboFan;
using Jet_Fuel;


namespace Engine_PurePower_PW1000G
{
    public class PurePower_PW1000G : IDisposable
    {
        //// Input Values
        ...
        Real_TurboFan engine;

        public PurePower_PW1000G(double M_0, double h, Fuel fuel, double th, bool bae, bool nfl, double alpha, double d)
        {
            ...
            engine = new Real_TurboFan(h, M_0, fuel.hpr(), fuel.T0_4(), pi_c, pi_f, pi_dmax, alpha, ec, ef, et, eta_b, eta_m, pi_n, P0P7, P0P9, bae, th, d, fuel.mr(), fuel.fw());
